                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Nhập mô tả" name="display_name" class="form-control" rows="4">{{$role->display_name}}</textarea>
                            </div>
                                    ...
                                    <div class="row">
                                        @foreach($permissionsParent->permissionsChildren as $permissionsChild)
                                            <div class="card-body text-primary col-md-3">
                                                <h5 class="card-title">
                                                    <label>
                                                        <input {{$permissionsChecked->contains('id',$permissionsChild->id)?'checked':''}}
                                                               type="checkbox" class="checkbox_children" name="permission_id[]"
